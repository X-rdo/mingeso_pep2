...
function MainComponents() {
    ...
    const handleClickSubidaArchivo = () => {
        navigate("/subir_archivo");
    };
    ...
    return (
        <div>
            ...
            <div className="container_main">
                ...
                <div className="card" onClick={handleClickSubidaArchivo}>
                    <img id="subir_archivo" src={ListaCuotas} alt="Imagen_3" />
                    <h2>Subir archivo</h2>
                </div>
                <div className="card" onClick={handleClickResumen}>
                    <img id="resumen" src={ListaCuotas} alt="Imagen_3" />
                    <h2>Resumen estudiante</h2>
                </div>
            </div>
        </div>
    );
